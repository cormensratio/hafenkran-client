...
const UserStore = {
  state: {
    ...
    userList: [
      { id: 437528034832593475239, name: 'testuser', isAdmin: false, email: '' },
      { id: 23479852737952743986, name: 'Bruce Wayne', isAdmin: false, email: 'Joker@gmail.com' },
      { id: 338925734070537954, name: 'Harry Potter', isAdmin: false, email: '' },
      { id: 430324905809683046, name: 'Tony Stark', isAdmin: false, email: '' },
      { id: 53603248906493060946, name: 'Pepper Pots', isAdmin: false, email: '' },
      { id: 6960283409683680643, name: 'Ganondorf', isAdmin: false, email: '' },
      { id: 142462364362374, name: 'Calzone', isAdmin: false, email: '' },
      { id: 738475894373807235, name: 'Yo Mama', isAdmin: false, email: '' },
      { id: 93846780234634624, name: 'Legolas', isAdmin: false, email: '' },
      { id: 139480534850471328479, name: 'Doritos', isAdmin: false, email: '' },
    ],
    pendingUsers: [
      { id: 11, name: 'Nudelauflauf', isAdmin: false, email: '' },
      { id: 12, name: 'Mozart Rella', isAdmin: false, email: '' },
      { id: 13, name: 'Bazooka', isAdmin: false, email: '' },
    ],
  },
  getters: {
